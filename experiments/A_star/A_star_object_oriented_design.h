...
void A_star_object_oriented_design_sequential(design::Design &design, Metric &metric);
void A_star_object_oriented_design_parallel(design::Design &design, Metric &metric);
